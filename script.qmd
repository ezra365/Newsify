...
rating = "Ezra" # Please capitalise the first letter of the rating for consistency
comment = "I found the summary very informative and well-written."
response = submit_feedback(url, summary, rating, comment)
print(response)

# heroku pg:psql - command to open postgresql interface in terminal and view feedback
