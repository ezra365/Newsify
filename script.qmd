...
def submit_feedback(url, summary, rating, comment=''):
    ...
    response = requests.post("http://127.0.0.1:5000/submit_feedback", json=feedback_data)
    return response.json()

# Example usage - please fill in your own so I can iterate on the prompt engineering
